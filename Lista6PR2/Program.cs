...
namespace Lista6PR2
{
    internal class Program
    {
        ...
        {
            int op, i=0, quant = 1, quantt = 0, v, vt, vtt = 0, nItens, parar = 2, av, cont=1, num, dia, N;
            float menorV, maiorV, p, peso, speso=0, h, IMC;
            string nome = "", nome1 = "", nomeMa = "", nomeMe = "", sg;
            ...
            switch (op)
            {
                ...
                case 2:
                    ...
                    Console.WriteLine("Maior quantia investida no produto " + nome + " é: " + maiorV);
                    Console.WriteLine("Menor quantia investida no produto " + nome + " é: " + menorV);
                    Console.ReadKey();
                    break;
                case 3:
